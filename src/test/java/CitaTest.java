...
public class CitaTest {
    ...
    public void testCitaPresencial() {
        ...
        assertTrue(cita instanceof Cita, "CitaPresencial no hereda correctamente de Cita");


        assertEquals("Carlos", cita.getPaciente().getNombre());
        assertEquals("Dr. López", cita.getMedico().getNombre());
        assertEquals("2025-10-21", cita.getFecha());
    ...
    public void testCitaVirtual() {
        ...
        assertTrue(cita instanceof Cita, "CitaVirtual no hereda de Cita");
